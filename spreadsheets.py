...
def add_result_to_worksheet(survey_results_name, user_data, result_list):
    sh = get_spreadsheet()

    try:
        sh.worksheet(survey_results_name)
    except gspread.exceptions.WorksheetNotFound:
        ws = sh.add_worksheet(survey_results_name, 0, 0)
    ...
    ws = sh.worksheet(survey_results_name)
